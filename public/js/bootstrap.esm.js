...
class Tab extends BaseComponent {
  ...
  _activate(element, relatedElem) {
    ...
    this._activate(SelectorEngine.getElementFromSelector(element)); // Search and activate/show the proper sections
  ...
  _deactivate(element, relatedElem) {
    ...
    element.blur();
    this._deactivate(SelectorEngine.getElementFromSelector(element)); // Search and deactivate the shown sections too
